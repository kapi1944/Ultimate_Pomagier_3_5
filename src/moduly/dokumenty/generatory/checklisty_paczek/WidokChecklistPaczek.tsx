...
import { PasekAkcjiGeneratora, UkladPaneliGeneratora } from '../../wspolne/UkladGeneratoraDokumentu'
import {
...
export default function WidokChecklistPaczek({ dokumentIdZTrasy }: WlasciwosciWidokuChecklistPaczek) {
  ...
  return <section className="widok checklista-paczki">
    ...
    </div><aside className="checklista-paczki__panel-podgladu"><h2>Podgląd wydruku</h2><DrukChecklisty dane={dane} nazwaOpiekuna={nazwaOpiekuna} nazwaWysylacza={nazwaWysylacza} /></aside></UkladPaneliGeneratora>
  </section>
}
