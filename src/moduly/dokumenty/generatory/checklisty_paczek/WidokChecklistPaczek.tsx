...
import { ObszarZPanelemGeneratora, PanelBocznyGeneratora, PasekAkcjiGeneratora, PrzyciskPaneluGeneratora, UkladPaneliGeneratora } from '../../wspolne/UkladGeneratoraDokumentu'
import {
...
export default function WidokChecklistPaczek({ dokumentIdZTrasy }: WlasciwosciWidokuChecklistPaczek) {
  ...
  return <ObszarZPanelemGeneratora idPanelu="panel-podgladu-checklisty-paczki" kluczPrzypiecia="ultimate-pomagier.panel-generatora.checklisty-paczek.przypiety" kluczWysuwania="ultimate-pomagier.panel-generatora.checklisty-paczek.wysuwanie" szerokoscPanelu="680px" tytulPanelu="Podgląd wydruku"><section className="widok checklista-paczki">
    ...
    <UkladPaneliGeneratora className="checklista-paczki__uklad-roboczy"><div className="checklista-paczki__formularz">
    ...
    </div><PanelBocznyGeneratora className="checklista-paczki__panel-podgladu"><DrukChecklisty dane={dane} nazwaOpiekuna={nazwaOpiekuna} nazwaWysylacza={nazwaWysylacza} /></PanelBocznyGeneratora></UkladPaneliGeneratora>
