...
export const daneStartoweUzytkownikow: Uzytkownik[] = [
  utworzUzytkownika({ id: 'architekt-systemu', zwrot: 'Pan', tytulNaukowy: '', imie: 'Architekt', nazwisko: 'Systemu', pseudonim: 'Architekt systemu', emaile: ['architekt@pomagier.local'], telefony: [{ prefiks: '+48', numer: '500 000 001' }], login: 'architekt', rola: 'ADMINISTRATOR', organizacja: 'SEMPER', odznaki: ['WYSYLACZ', 'AKCEPTUJACY', 'EKSPORTER', 'ROZLICZAJACY', 'AUDYTOR'], status: 'AKTYWNY', kolorProfilu: '#38761d', aliasyHistoryczne: ['architekt', 'Architekt'] }),
  utworzUzytkownika({ id: 'administrator-kacper-madej', zwrot: 'Pan', tytulNaukowy: 'mgr inż.', imie: 'Kacper', nazwisko: 'Madej', pseudonim: 'Kacper', emaile: ['kacper.madej@pomagier.local', 'administrator@pomagier.local'], telefony: [{ prefiks: '+48', numer: '501 234 567' }], login: 'kacper.madej', rola: 'ARCHITEKT', organizacja: 'SEMPER', odznaki: ['WYSYLACZ', 'AKCEPTUJACY', 'EKSPORTER', 'ROZLICZAJACY', 'AUDYTOR'], status: 'AKTYWNY', kolorProfilu: '#cc0000', aliasyHistoryczne: ['Kacper', 'administrator'] }),
  utworzUzytkownika({ id: 'opiekun-anna-nowak', zwrot: 'Pani', tytulNaukowy: 'mgr', imie: 'Anna', nazwisko: 'Nowak', pseudonim: 'Ania', emaile: ['anna.nowak@pomagier.local'], telefony: [{ prefiks: '+48', numer: '502 345 678' }], login: 'anna.nowak', rola: 'OPIEKUN', organizacja: 'SEMPER', odznaki: ['AKCEPTUJACY'], status: 'AKTYWNY', kolorProfilu: '#8e7cc3', aliasyHistoryczne: ['Ania'] }),
  utworzUzytkownika({ id: 'opiekun-piotr-zielinski', zwrot: 'Pan', tytulNaukowy: 'dr', imie: 'Piotr', nazwisko: 'Zieliński', pseudonim: 'Piotr', emaile: ['piotr.zielinski@pomagier.local'], telefony: [{ prefiks: '+48', numer: '503 456 789' }], login: 'piotr.zielinski', rola: 'OPIEKUN', organizacja: 'IIST', odznaki: ['AKCEPTUJACY'], status: 'AKTYWNY', kolorProfilu: '#76a5af', aliasyHistoryczne: [] }),
